...
# polymer build -v --preset es5-bundled --root $APP --entrypoint $APP/require.html
...
# npx babel $DIST/js/lib.js --out-file $DIST/js/lib-babel.js --presets=env,babel-polyfill
# mv $DIST/js/lib-babel.js $DIST/js/lib.js
