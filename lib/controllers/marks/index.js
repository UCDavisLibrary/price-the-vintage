...
class MarksController {
  ...
  updateTempMark(pageId, xy) {
    ...
    if( this.tmpMarkRef ) {
      this.tmpMarkRef.ref.set(null);
      this.tmpMarkRef.disconnect.cancel();
    }

    this.tmpMarkRef = {};
    var ref = firebase.database().ref(`${dbns}/marks/${pageId}/${this.tmpMarkId}`);
    var disconnect = ref.onDisconnect();
    disconnect.set(null);

    this.tmpMarkRef.ref = ref;
    this.tmpMarkRef.disconnect = disconnect;
