...
class MarksStore extends BaseStore {
  ...
  constructor() {
    ...
    // this.events.PENDING_MARK_SEARCH_UPDATE = 'pending-mark-search-update';
    // this.events.MARKS_APPROVED = 'approved-catalog-page-marks-update';
    // this.events.MARKS_UPDATE = 'catalog-page-marks-update';
